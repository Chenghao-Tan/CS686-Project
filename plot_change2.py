...
path = r"D:\Desktop\686p\results\analysis\pred_noref_opttrain.csv"
df3 = pd.read_csv(path, index_col=False)
df3["correct"] = df3["correct"].astype(int)
path = r"D:\Desktop\686p\results\analysis\pred_ref_opttrain.csv"
df4 = pd.read_csv(path, index_col=False)
df4["correct"] = df4["correct"].astype(int)
